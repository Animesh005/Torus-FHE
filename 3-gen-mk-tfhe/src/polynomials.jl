...
int_polynomial_new(coeffs) = Polynomial{Int64,length(coeffs)}(coeffs, negacyclic_modulus,mul_naive)
torus_polynomial_new(coeffs) = Polynomial{Torus64,length(coeffs)}(coeffs, negacyclic_modulus,mul_naive)
